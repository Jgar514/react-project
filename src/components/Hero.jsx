...
const Hero = () => {
	return (
		<section
			className={`relative w-full h-screen mx-auto bg-black overlow-hidden
		`}
		>
			<div className={`${styles.paddingX} absolute inset-0 top-[430px] md:top-[100px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
