...
const Hero = () => {
	return (
		<section
			className={`relative w-full h-screen mx-auto bg-black overlow-hidden mt-4
		`}
		>
			<div className={`${styles.paddingX} absolute inset-0 top-[410px] md:top-[100px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
